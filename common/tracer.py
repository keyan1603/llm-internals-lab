...
# metadata. Here a "stage" is one Gemini call (embed, generate, count
# tokens, or a logprobs attempt) inside one ticket's triage pipeline.
...
class Tracer:
    """One Tracer per pipeline run. Every span logged through it shares
    the same trace_id."""
